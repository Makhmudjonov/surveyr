                        ...
                        <div class="card-body">  
                            ...
                            <form action="@route('update.password')" id="resetForm" class="p-2">  
                                ...
                                <div class="mb-3 text-center">  
                                    <button class="btn btn-primary w-100" id="btnReset" type="submit"> Parolni tiklash </button>  
                                </div>  
                            </form>  
                            ...
                            <div class="row mt-2">  
                                <div class="col-sm-12 text-center">  
                                    <p class="text-muted mb-0 fs-9">  
                                        ...
                                        <a class="fw-bold" href="@route('login')" class="text-dark ml-1">Kirish</a>  
                                    </p>  
                                </div>  
                            </div>  
    ...
    <script>  
        $('#resetForm').submit(function(e) {  
            ...
            $.ajax({  
                ...
                complete: function() {  
                    buttonState('#btnReset', 'reset', 'Parolni tiklash');  
                }     
            });  
        });  
    </script>  
