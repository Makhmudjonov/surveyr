        ...
        <div class="row">
            <div class="col-12 mb-4 position-relative">
                ...
                <div class="position-absolute end-5 top-0">
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary btn-sm" id="purgeFormSubmissions" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Barcha ma'lumotlarni tozalash">
                        <i class="fa-solid fa-trash"></i>
                    </a>

                    <a href="@route('forms.visualize', $form->id)" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-chart d-inline d-md-none"></i>
                        <span class="d-none d-md-inline">Vizualizatsiya</span>
                    </a>                    
                </div>
            </div>
        </div>
        ...
        @else
            <div class="py-5">
                @include('components.empty', [
                    'emptyTitle' => 'Hech qanday yozuv topilmadi',
                    'emptyText' => 'Bu forma bo‘yicha hali hech qanday ma’lumot yuborilmagan.'
                ])
            </div>
        @endif
    </div>
